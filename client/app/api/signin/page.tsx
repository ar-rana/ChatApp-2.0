  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black">
      <div className="bg-white shadow-md rounded-lg p-6 max-w-md w-full">
        ...
        <p className="text-center text-gray-500 mb-6">Sign In using your Google account</p>
        <div className="text-center">
            <div onClick={() => signIn('google', {callbackUrl: "/"})} className="flex justify-center space-x-2 bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-blue-500 focus:ring-2 focus:ring-blue-800 cursor-pointer">
