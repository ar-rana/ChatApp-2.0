      ...
      <div className="h-screen overflow-x-hidden">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 h-full flex flex-col">
          <div className="relative mx-auto grid space-y-5 sm:space-y-10 h-full max-w-2xl">
            <div className="overflow-y-scroll mx-auto p-5 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20 flex flex-col h-full">
              <div className="flex space-x-2 mb-4 sticky top-0">
                <input
                  type="text"
